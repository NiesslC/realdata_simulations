...
# [7] "OV_RNASeq2Gene-20160128"   "SKCM_RNASeq2Gene-20160128" "TGCT_RNASeq2Gene-20160128"
#[10] "UCS_RNASeq2Gene-20160128"  "UVM_RNASeq2Gene-20160128"
...
save(mean.normal_all, mean.cancer_all, mean.total_all,
     disp.normal_all, disp.cancer_all, disp.total_all,
...
cbind(length(param$k_index.filter),
      length(tcga_parameters$`KIRC_RNASeq2Gene-20160128`$k_index.filter))
cbind(summary(param$k_mean.total),
      summary(tcga_parameters$`KIRC_RNASeq2Gene-20160128`$k_mean.total))
cbind(summary(param$k_disp.total),
      summary(tcga_parameters$`KIRC_RNASeq2Gene-20160128`$k_disp.total))
# -> very similar
